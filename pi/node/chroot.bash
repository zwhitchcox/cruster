...
sudo /usr/bin/python3 ${CRUSTER_DIR}/upnp-server.py &
sudo /usr/bin/python3 ${CRUSTER_DIR}/api-server.py &
sudo dphys-swapfile swapoff &
exit 0" >> /etc/rc.local

# Set standard cluster info
echo node > /etc/hostname
mkdir -p "${CRUSTER_DIR}"
touch ${CRUSTER_DIR}/clustername
touch ${CRUSTER_DIR}/masterip
